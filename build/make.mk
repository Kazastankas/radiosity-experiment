...
CXX = g++
CXXFLAGS += -Wall -ansi -Wextra -I"$(CURR_DIR)/$(SRC_DIR)" -I"$(CUDA_H_PATH)" -I"$(CUTIL_H_PATH)" $(COMPILER_FLAGS)

# cuda compiler flags
NVCC := nvcc
NVCCFLAGS_NOEXTRA = -I"$(CURR_DIR)/$(SRC_DIR)" -I"$(CUDA_H_PATH)" -I"$(CUTIL_H_PATH)"
...
LDFLAGS += -L"$(CUDA_LIB_PATH)" -L"$(CUTIL_LIB_PATH)" -L./$(BIN_DIR) $(LINK_LIBRARIES)
